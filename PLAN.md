...
Sprint 60 완료 (2026-05-21). 다음 스프린트 우선순위:
...
- **P2**: `『』` behavioral 테스트 — `"제3조『인용』"` → `Some(2)` + closer 대칭 확인 (Sprint 60 리뷰 S2).
- **P3**: `"제3조-제5조는 적용 제외"` 행동 확인 — 현재 `Some(2)` 반환(dash terminator 분기; 뒤의 '는' 미도달). 버그인지 정책인지 테스트로 고정 (Sprint 60 리뷰 S3).

...
Sprint 58 완료 (2026-05-21). 다음 스프린트 우선순위:
...
- **P2**: `is_heading_terminator` 허용 집합 보강 (Sprint 58 리뷰 LOW-1) — `《》`/`〈〉` CJK title brackets + `, ， - ~` 테스트 추가.
- **P3**: `convert_tests_detect.rs` 섹션 주석 갱신 — `S57-P3` → `S58-P2/P3` (Sprint 58 리뷰 cosmetic).

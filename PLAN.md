...
Sprint 61 완료 (2026-05-22). 다음 스프린트 우선순위:
...
- **P2**: `「」` behavioral 테스트 (Sprint 61 리뷰 제안) — `"제3조「참조」"` → `Some(2)`; `"제3조」참조"` → `Some(2)`. 『』와 함께 한국어 법령에서 가장 흔한 인용 부호 쌍.
- **P3**: assertion 메시지 nit — 3개 behavioral 테스트 메시지에 입력 문자열 포함 (Sprint 61 리뷰 nit).

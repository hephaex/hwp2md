...
Sprint 59 완료 (2026-05-21). 다음 스프린트 우선순위:
...
- **P2**: `is_heading_terminator` 허용 집합 — `『』` (match arm에 있으나 미테스트) 어서션 추가 (Sprint 59 리뷰 S2).
- **P3**: `제3조-제5조` 범위 표현 행동 테스트 추가 — `-` 이 단독 char 테스트 대신 실제 패턴을 커버 (Sprint 59 리뷰 S3).
